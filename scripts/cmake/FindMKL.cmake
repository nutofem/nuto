...
# \author    J. Bakosi, modified T. Titscher (add cmake target)
...
find_path(MKL_INCLUDE_DIR NAMES mkl.h HINTS $ENV{MKLROOT}/include /opt/intel/mkl/include)
string(REPLACE "/include" "" MKL_ROOT ${MKL_INCLUDE_DIR})
...
if (MKL_INCLUDE_DIR AND
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DMKL_LP64 ${ABI} -DHAVE_MKL")
...
#message(STATUS ${mkl_link_libs})
#
#add_library(MKL::MKL SHARED IMPORTED)
#set_target_properties(MKL::MKL PROPERTIES
#    IMPORTED_LOCATION "${MKL_LIBRARIES} ${MKL_CORE_LIBRARIES} ${MKL_INTERFACE_LIBRARY} ${MKL_SEQUENTIAL_LAYER_LIBRARY}"
#    INTERFACE_INCLUDE_DIRECTORIES "${MKL_INCLUDE_DIRS}"
#    INTERFACE_COMPILE_DEFINITIONS "HAVE_MKL")
#    #INTERFACE_LINK_LIBRARIES "${mkl_link_libs}")
#
