...
BOOST_AUTO_TEST_CASE(NewmarkPlane2D4N)
{
    ...
    myStructure.InterpolationTypeAdd(meshInfo.second, NuTo::Node::eDof::DISPLACEMENTS,
    ...
    myStructure.ConstitutiveLawSetParameterDouble(myMatLattice,
                                                  NuTo::Constitutive::eConstitutiveParameter::YOUNGS_MODULUS, 30000);
    myStructure.ConstitutiveLawSetParameterDouble(myMatLattice,
                                                  NuTo::Constitutive::eConstitutiveParameter::POISSONS_RATIO, 0.0);
    myStructure.ConstitutiveLawSetParameterDouble(myMatLattice, NuTo::Constitutive::eConstitutiveParameter::DENSITY,
                                                  density);
    ...
    myStructure.LoadCreateNodeForce(myStructure.NodeGetId(&nodeLeftBottom), Eigen::Vector2d::UnitX(), 1);
