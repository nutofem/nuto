...
void CoefficientCheckLinearElasticTriangle(NuTo::Interpolation::eTypeOrder rTypeOrder)
{
    ...
    nodeCoordinates << 0, 10, 2, 8, 4, 8, 0, 10, 0, 0, 2, 3, 7, 7, 10, 10;
    ...
    nodeNumbers << 0, 0, 0, 1, 2, 2, 3, 3, 4, 5, 1, 2, 3, 7, 4, 3, 5, 7, 5, 7, 3, 6, 2, 3, 6, 4, 4, 5, 6, 6;
    ...
    myStructure.Constraints().Add(NuTo::Node::eDof::DISPLACEMENTS,
                                  NuTo::Constraint::Component(node, {NuTo::eDirection::X}));
    myStructure.CalculateMaximumIndependentSets();
