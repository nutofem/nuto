...
void CheckDamageLaws()
{
    ...
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DENSITY,1.0);
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::YOUNGS_MODULUS,30000);
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::POISSONS_RATIO,0.3);
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::NONLOCAL_RADIUS,1.0);
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::TENSILE_STRENGTH,4.);
    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::FRACTURE_ENERGY,0.21);

    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DAMAGE_LAW, static_cast<double>(eDamageLawType::ISOTROPIC_NO_SOFTENING));
    CheckDamageLawsDerivatives(myConstitutiveLaw);

    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DAMAGE_LAW, static_cast<double>(eDamageLawType::ISOTROPIC_LINEAR_SOFTENING));
    CheckDamageLawsDerivatives(myConstitutiveLaw);

    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DAMAGE_LAW, static_cast<double>(eDamageLawType::ISOTROPIC_EXPONENTIAL_SOFTENING));
    CheckDamageLawsDerivatives(myConstitutiveLaw);

    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DAMAGE_LAW, static_cast<double>(eDamageLawType::ISOTROPIC_EXPONENTIAL_SOFTENING_RES_LOAD));
    CheckDamageLawsDerivatives(myConstitutiveLaw);

    myConstitutiveLaw.SetParameterDouble(eConstitutiveParameter::DAMAGE_LAW, static_cast<double>(eDamageLawType::ISOTROPIC_CUBIC_HERMITE));
    CheckDamageLawsDerivatives(myConstitutiveLaw);
}
...
int SetConstitutiveLaw(NuTo::Structure& rStructure)
{
    ...
    rStructure.ConstitutiveLawSetParameterDouble(lawId,eConstitutiveParameter::MAX_OMEGA, 0.925);
    rStructure.ConstitutiveLawSetDamageLaw(lawId, eDamageLawType::ISOTROPIC_EXPONENTIAL_SOFTENING);
    BOOST_CHECK_CLOSE(rStructure.ConstitutiveLawGetParameterDouble(lawId, eConstitutiveParameter::MAX_OMEGA), 0.925, 1.e-10);
    return lawId;
}
