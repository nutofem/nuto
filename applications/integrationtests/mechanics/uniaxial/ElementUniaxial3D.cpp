...
void Run(eShapeType rShapeType, eTypeOrder rTypeOrder, std::array<int, 3> rDiv)
{
    ...
    auto meshInfo = NuTo::MeshGenerator::Grid<3>(s, {test.lX, test.lY, test.lZ}, rDiv, rShapeType);
