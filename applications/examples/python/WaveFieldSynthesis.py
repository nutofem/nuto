...
"""
calculates the distance from line l_0 + t * n to the point p
"""
...
def run_time_integration(s, result_directory, end_time):
    ...
    ti.SetResultDirectory(result_directory, True)
    ti.Solve(end_time)


"""
This currently assumes that the point source only influences
the WEST border of the domain. EAST, NORTH and SOUTH are in
the _shadow_ of WEST
"""
...
Assumes that l_0 is in the SOUTH_WEST of the domain and n pointing
towards it. So the bcs are applied to the SOUTH and the WEST boundary
and NORTH and EAST are in their shadow
"""
