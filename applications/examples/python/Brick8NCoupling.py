...
structure.LoadCreateNodeForce(0, 28, direction, 1)
structure.LoadCreateNodeForce(0, 29, direction, 1)
structure.LoadCreateNodeForce(0, 30, direction, 1)
structure.LoadCreateNodeForce(0, 31, direction, 1)
