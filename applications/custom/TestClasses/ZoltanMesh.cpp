...
//int ZoltanMesh<zoltanElementType>::get_number_of_localElements(void *data, int *ierr)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::get_localElement_list(void *data, int sizeGID, int sizeLID, ZOLTAN_ID_PTR globalID, ZOLTAN_ID_PTR localID, int wgt_dim, float *obj_wgts, int *ierr)
//{
//    ZoltanMesh* mesh = (ZoltanMesh*)data;
//    *ierr = ZOLTAN_OK;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::get_number_of_localNodes_localPins(void *data, int *num_lists, int *num_nonzeroes, int *format, int *ierr)
//{
//    ZoltanMesh* mesh = (ZoltanMesh*)data;
//    *ierr = ZOLTAN_OK;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::get_hypergraph(void *data, int sizeGID, int num_edges, int num_nonzeroes, int format, ZOLTAN_ID_PTR edgeGID, int *vtxPtr, ZOLTAN_ID_PTR vtxGID, int *ierr)
//{
//    ZoltanMesh* mesh = (ZoltanMesh*)data;
//    *ierr = ZOLTAN_OK;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::showHypergraph_1D(int myProc, int numProcs, int numLocalIDs, int numGlobalIDs, ZOLTAN_ID_TYPE *GIDs, int *parts)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::printMesh(int myProc, ZoltanMesh *mesh)
//{
...
//template <typename zoltanElementType>
//int ZoltanMesh<zoltanElementType>::get_element_size(void *data, int gidSize, int lidSize, ZOLTAN_ID_PTR globalID, ZOLTAN_ID_PTR localID, int *ierr)
//{
...
//template <typename zoltanElementType>
//int ZoltanMesh<zoltanElementType>::get_element_size_elementFEM(void *data, int gidSize, int lidSize, ZOLTAN_ID_PTR globalID, ZOLTAN_ID_PTR localID, int *ierr)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::get_element_sizes(void *data, int gidSize, int lidSize, int num_ids, ZOLTAN_ID_PTR globalIDs, ZOLTAN_ID_PTR localIDs, int *sizes, int *ierr)
//{
//    ZoltanMesh *mesh;
//    int len;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::pack_element(void *data, int gidSize, int lidSize, ZOLTAN_ID_PTR globalID, ZOLTAN_ID_PTR localID, int dest, int size, char *buf, int *ierr)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::pack_element_elementFEM(void *data, int gidSize, int lidSize, ZOLTAN_ID_PTR globalID, ZOLTAN_ID_PTR localID, int dest, int size, char *buf, int *ierr)
//{
//    ZoltanMesh* mesh = (ZoltanMesh*)data;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::pack_elements(void *data, int gidSize, int lidSize, int num_ids, ZOLTAN_ID_PTR globalIDs, ZOLTAN_ID_PTR localIDs, int *dests, int *sizes, int *idx, char *buf, int *ierr)
//{
//    int num_nbors;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::unpack_element(void *data, int gidSize, ZOLTAN_ID_PTR globalID, int size, char *buf, int *ierr)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::unpack_element_elementFEM(void *data, int gidSize, ZOLTAN_ID_PTR globalID, int size, char *buf, int *ierr)
//{
//    ZoltanMesh* mesh = (ZoltanMesh*)data;
//    int numElems = mesh->numLocalElements + 1;
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::unpack_elements(void *data, int gidSize, int num_ids, ZOLTAN_ID_PTR globalIDs, int *size, int *idx, char *buf, int *ierr)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::mid_migrate(void *data, int gidSize, int lidSize, int numImport, ZOLTAN_ID_PTR importGlobalID, ZOLTAN_ID_PTR importLocalID, int *importProc, int *importPart,
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::mid_migrate_elementFEM(void *data, int gidSize, int lidSize, int numImport, ZOLTAN_ID_PTR importGlobalID, ZOLTAN_ID_PTR importLocalID, int *importProc, int *importPart, int numExport, ZOLTAN_ID_PTR exportGlobalID, ZOLTAN_ID_PTR exportLocalID, int *exportProc, int *exportPart, int *ierr)
//{
//    ZoltanMesh *mesh;
//    int *exports;
...
//template <typename zoltanElementType>
//ZoltanMesh<zoltanElementFEM_1D> ZoltanMesh<zoltanElementType>::create_1D_mesh(int rNodeCount)
//{
//    int dim = 1;
//    ZoltanMesh<zoltanElementFEM_1D> mesh(dim);
...
//    for (int i = 0; i < elementCount; ++i)
//    {
////        NuTo::NodeSimple n_i0(i*h);
////        NuTo::NodeSimple n_i1((i+1)*h);

////        mesh.zoltanFEMElements.push_back({i, {n_i0, n_i1}, interpolation});
////        mesh.zoltanFEMElements.push_back({i, {n_i0, n_i1}});
////        mesh.zoltanFEMElements.push_back({i, {i, i+1}});
////        zoltanNode n0(i, i*h);
////        zoltanNode n1(i+1, (i+1)*h);
...
//template <typename zoltanElementType>
//ZoltanMesh<zoltanElementFEM_2D_QUAD> ZoltanMesh<zoltanElementType>::create_2D_mesh()
//{
//    /* Something like this:
//     *
//     *    3-----------------------2
...
//    zoltanNode<2,1> n_0(0, Eigen::Vector2d(0, 0));
//    zoltanNode<2,1> n_1(1, Eigen::Vector2d(10, 0));
//    zoltanNode<2,1> n_2(2, Eigen::Vector2d(10, 10));
//    zoltanNode<2,1> n_3(3, Eigen::Vector2d(0, 10));
//    zoltanNode<2,1> n_4(4, Eigen::Vector2d(2, 2));
//    zoltanNode<2,1> n_5(5, Eigen::Vector2d(8, 3));
//    zoltanNode<2,1> n_6(6, Eigen::Vector2d(8, 7));
//    zoltanNode<2,1> n_7(7, Eigen::Vector2d(4, 7));
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::distributeToRoot(int rRank, int rNumProc, ZoltanMesh *rMesh)
//{
...
//template <typename zoltanElementType>
//void ZoltanMesh<zoltanElementType>::distribute(int rRank, int rNumProc, ZoltanMesh *rMesh)
//{
//    int num, count, nnbors, ack=0;
//    int to=-1, from, remaining;
//    int send_count[3];
