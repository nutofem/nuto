...
IF(ARPACK_ROOT)
  ...
  SET(_ARPACK_INCLUDE_SEARCH_DIRS ${ARPACK_ROOT}/include ${ARPACK_ROOT} ${_ARPACK_INCLUDE_SEARCH_DIRS})
  SET(_ARPACK_LIBRARIES_SEARCH_DIRS ${ARPACK_ROOT}/lib ${ARPACK_ROOT} ${_ARPACK_LIBRARIES_SEARCH_DIRS})
ENDIF(ARPACK_ROOT)

# search for header ARPACK.h
FIND_PATH(ARPACK_INCLUDE_DIR NAMES Arpack/Arpack.h HINTS ${_ARPACK_INCLUDE_SEARCH_DIRS})
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ARPACK DEFAULT_MSG ARPACK_LIBRARIES ARPACK_INCLUDE_DIR)
