...
Eigen::VectorXd InterpolationTriangle4thOrder::GetShapeFunctions(const NaturalCoords& naturalIpCoords) const
{
    return ShapeFunctions(naturalIpCoords);
}

Eigen::MatrixXd InterpolationTriangle4thOrder::GetDerivativeShapeFunctions(const NaturalCoords& naturalIpCoords) const
{
...
Eigen::Matrix<double, 2, 1> InterpolationTriangle4thOrder::LocalCoords(int rNodeIndex)
{
    switch (rNodeIndex)
    {
    case 0:
...
Eigen::Matrix<double, 15, 1> InterpolationTriangle4thOrder::ShapeFunctions(const Eigen::VectorXd& rCoordinates)
{
...
InterpolationTriangle4thOrder::DerivativeShapeFunctions(const Eigen::VectorXd& rCoordinates)
{
