...
NuTo::CollisionHandler::CollisionHandler(ParticleHandler& rSpheres, SubBoxHandler& rSubBoxes, const std::string rName)
    : mName(rName)
...
void NuTo::CollisionHandler::LogStatus(Logger& rLogger, const long rTimeStep, const double rGlobalTime,
