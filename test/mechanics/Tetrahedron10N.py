...
myNode2 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(1,0,0)))
myNode3 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0,1,0)))
myNode4 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0,0,1)))
myNode5 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0.5,0,0)))
myNode6 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0.5,0.5,0)))
myNode7 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0.0,0.5,0)))
myNode8 = myStructure.NodeCreate("displacements",nuto.DoubleFullMatrix(3,1,(0,0,0.5)))
...
myStructure.NodeSetDisplacements(myNode5,nuto.DoubleFullMatrix(3,1,(0.20805,0.,0.)))
myStructure.NodeSetDisplacements(myNode6,nuto.DoubleFullMatrix(3,1,(0.091168,0.,0.)))
myStructure.NodeSetDisplacements(myNode9,nuto.DoubleFullMatrix(3,1,(0.026560,0.,0.)))
...
if createResult:
    ...
    FiCorrect = nuto.DoubleFullMatrix(30,1)
