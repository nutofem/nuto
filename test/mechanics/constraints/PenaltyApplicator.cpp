...
#include "nuto/mechanics/constraints/PenaltyApplicator.h"
...
BOOST_FIXTURE_TEST_CASE(ApplyUsingPenalty, ConstrainedSystem)
{
    PenaltyApplicator applicator({equation});
    ...
    BoostUnitTest::CheckEigenMatrix(u, expected_result, 1e-6);
}

BOOST_FIXTURE_TEST_CASE(PeriodicUsingPenalty, PeriodicSystem)
{
    PenaltyApplicator applicator({periodicEquation, centerEquation});
