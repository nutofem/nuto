...
#create nodes
myNode1 = myStructure.NodeCreate("displacements",nuto.DoubleFullVector((-1,-1)))
myNode4 = myStructure.NodeCreate("displacements",nuto.DoubleFullVector((+2,-1)))
myNode3 = myStructure.NodeCreate("displacements",nuto.DoubleFullVector((+2,+1)))
myNode2 = myStructure.NodeCreate("displacements",nuto.DoubleFullVector((-1,+1)))

#create element
myElement1 = myStructure.ElementCreate("PLANE2D4N",nuto.IntFullVector((myNode1,myNode2,myNode3,myNode4)))
...
myStructure.NodeSetDisplacements(myNode2,nuto.DoubleFullVector((0.1,0.2)))
myStructure.NodeSetDisplacements(myNode3,nuto.DoubleFullVector((0.1,0.2)))
