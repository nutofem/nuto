                               ...
                               int &groupElementsIGAlayer, int &slaveElementsGroupId, int &masterElementsGroupId, int &groupElementsSlaveUpper, int &groupNodesSlaveUpper, int &groupElementsSlaveLower, int &groupElementsMasterUpper)
{
    ...
    slaveElementsGroupId = groupIndicesSlave.GetValue(0, 0);
    //int slaveElementsInterpolId = groupIndicesSlave.GetValue(0, 1);
    int slaveElementsInterpolId = myStructure->InterpolationTypeCreate(NuTo::Interpolation::eShapeType::QUAD2D);
    myStructure->InterpolationTypeAdd(slaveElementsInterpolId, NuTo::Node::eDof::COORDINATES, NuTo::Interpolation::eTypeOrder::LOBATTO2);
    myStructure->InterpolationTypeAdd(slaveElementsInterpolId, NuTo::Node::eDof::DISPLACEMENTS, NuTo::Interpolation::eTypeOrder::LOBATTO2);
    myStructure->ElementGroupSetInterpolationType(slaveElementsGroupId, slaveElementsInterpolId);
    myStructure->ElementConvertToInterpolationType(slaveElementsGroupId);

    //myStructure->InterpolationTypeSetIntegrationType(slaveElementsInterpolId,NuTo::eIntegrationType::IntegrationType2D4NLobatto16Ip,NuTo::IpData::eIpDataType::NOIPDATA);
...
//            double angle = std::atan2(y,x);
    ...
    //int masterElementsInterpId = groupIndicesMaster.GetValue(0, 1);
    int masterElementsInterpId = myStructure->InterpolationTypeCreate(NuTo::Interpolation::eShapeType::QUAD2D);
    myStructure->InterpolationTypeAdd(masterElementsInterpId, NuTo::Node::eDof::COORDINATES, NuTo::Interpolation::eTypeOrder::LOBATTO2);
    myStructure->InterpolationTypeAdd(masterElementsInterpId, NuTo::Node::eDof::DISPLACEMENTS, NuTo::Interpolation::eTypeOrder::LOBATTO2);
    myStructure->ElementGroupSetInterpolationType(masterElementsGroupId, masterElementsInterpId);
    myStructure->ElementConvertToInterpolationType(masterElementsGroupId);
...
int main(int argc, char* argv[])
{
    ...
    std::string fileNameSlave  = "indenterCircular.msh";
    std::string fileNameMaster = "masterHalfspace.msh";
    ...
    contactAlgo = 1;
    penalty = 1.e8;
    resultDir      = "./ResultsContactStatic";
