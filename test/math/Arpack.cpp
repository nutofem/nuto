...
int main(int argc, char* argv[])
{
    try
    {
        ...
        {
            std::cout << "error calculating eigenvalues using DSDRV1 with error "
                      << (eigenValues - eigenValuesStandardRef).norm() << std::endl;
        ...
        // if you want to calculate all eigenvalues closest to an given value, set Shift to this value and which to 'LM'
        // (fabs - both directions)
        ...
        if ((eigenValues - eigenValuesStandardRef).norm() > 1e-5)
        {
            std::cout << "error calculating eigenvalues using DSDRV2 with error "
                      << (eigenValues - eigenValuesStandardRef).norm() << std::endl;
        ...
        {
            std::cout << "error calculating eigenvalues using DSDRV3 with error "
                      << (eigenValues - eigenValuesGeneralRef).norm() << std::endl;
        ...
        if ((eigenValues - eigenValuesGeneralRef).norm() > 1e-5)
        {
            std::cout << "error calculating eigenvalues using DSDRV4 with error "
                      << (eigenValues - eigenValuesGeneralRef).norm() << std::endl;
        ...
        if ((eigenValues - eigenValuesGeneralRef).norm() > 1e-5)
        {
            std::cout << "error calculating eigenvalues using DSDRV5 with error "
                      << (eigenValues - eigenValuesGeneralRef).norm() << std::endl;
        ...
        if ((eigenValues - eigenValuesGeneralRef).norm() > 1e-5)
        {
            std::cout << "error calculating eigenvalues using DSDRV6 with error "
                      << (eigenValues - eigenValuesGeneralRef).norm() << std::endl;
        ...
        {
            std::cout << "error calculating eigenvalues using DNDRV1 with error "
                      << (eigenValuesSorted.col(0) - eigenValuesStandardRef).norm() << std::endl;
