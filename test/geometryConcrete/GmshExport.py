...
structure.ImportFromGmsh(mshFile2D,0,"displacements", "ConstitutiveLawIpNonlocal", "StaticDataNonlocal");
if structure.GetNumElements() == 0:
	print "Empty Structure"
	sys.exit(-1)

structure = nuto.Structure(3)
structure.ImportFromGmsh(mshFile3D,0,"displacements", "ConstitutiveLawIpNonlocal", "StaticDataNonlocal");
if structure.GetNumElements() == 0:
	print "Empty Structure"
	sys.exit(-1)
