...
NuTo::CollidableWallPhysical::CollidableWallPhysical(Eigen::Vector3d rPosition, Eigen::Vector3d rDirection, int rIndex)
...
double NuTo::CollidableWallPhysical::PredictCollision(CollidableParticleSphere& rSphere, int& rType)
{
    ...
    if (mIsAxisAligned)
    {
        ...
        staticDistanceToWall =
                sign * (rSphere.mPosition[mNonNullAxis] - this->mPosition[mNonNullAxis]) - rSphere.mRadius;
