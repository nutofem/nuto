...
{
    SetParameterDouble(
                Constitutive::eConstitutiveParameter::YOUNGS_MODULUS,mEfunc(coordinates));
}
...
NuTo::ConstitutiveInputMap NuTo::LinearElasticInhomogeneous::GetConstitutiveInputs(const ConstitutiveOutputMap& rConstitutiveOutput) const
{
