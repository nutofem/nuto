...
std::unique_ptr<NuTo::Constitutive::IPConstitutiveLawBase> NuTo::ShrinkageSAWStressBased::CreateIPLaw()
{
    return std::make_unique<Constitutive::IPConstitutiveLawWithoutData<ShrinkageSAWStressBased>>(*this);
}


bool NuTo::ShrinkageSAWStressBased::CheckDofCombinationComputable(NuTo::Node::eDof rDofRow, NuTo::Node::eDof rDofCol,
...
void NuTo::ShrinkageSAWStressBased::CheckParameters() const
{
}


NuTo::ConstitutiveInputMap
NuTo::ShrinkageSAWStressBased::GetConstitutiveInputs(const NuTo::ConstitutiveOutputMap& rConstitutiveOutput) const
{
...
NuTo::Constitutive::eConstitutiveType NuTo::ShrinkageSAWStressBased::GetType() const
{
    return NuTo::Constitutive::eConstitutiveType::SHRINKAGE_SAW_STRESS_BASED;
}

double NuTo::ShrinkageSAWStressBased::GetParameterDouble(NuTo::Constitutive::eConstitutiveParameter rIdentifier) const
{
    switch (rIdentifier)
    {
...
void NuTo::ShrinkageSAWStressBased::SetParameterDouble(NuTo::Constitutive::eConstitutiveParameter rIdentifier,
                                                       double rValue)
{
    switch (rIdentifier)
    {
...
template <int TDim>
void NuTo::ShrinkageSAWStressBased::Evaluate(const NuTo::ConstitutiveInputMap& rConstitutiveInput,
                                             const NuTo::ConstitutiveOutputMap& rConstitutiveOutput)
{
    ...
    for (auto& itOutput : rConstitutiveOutput)
    {
        ...
        case NuTo::Constitutive::eOutput::ENGINEERING_STRESS:
        {
            ...
            Eigen::Matrix<double, VoigtDim, 1>& engineeringStress =
        ...
        case NuTo::Constitutive::eOutput::D_ENGINEERING_STRESS_D_RELATIVE_HUMIDITY:
        {
            ...
            Eigen::Matrix<double, VoigtDim, 1>& engineeringStress_dRH =
                    static_cast<ConstitutiveVector<VoigtDim>*>(itOutput.second.get())->AsVector();
...
template void NuTo::ShrinkageSAWStressBased::Evaluate<1>(const NuTo::ConstitutiveInputMap& rConstitutiveInput,
                                                         const NuTo::ConstitutiveOutputMap& rConstitutiveOutput);
template void NuTo::ShrinkageSAWStressBased::Evaluate<2>(const NuTo::ConstitutiveInputMap& rConstitutiveInput,
                                                         const NuTo::ConstitutiveOutputMap& rConstitutiveOutput);
template void NuTo::ShrinkageSAWStressBased::Evaluate<3>(const NuTo::ConstitutiveInputMap& rConstitutiveInput,
                                                         const NuTo::ConstitutiveOutputMap& rConstitutiveOutput);
