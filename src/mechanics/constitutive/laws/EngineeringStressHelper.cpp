...
std::tuple<double, double, double> NuTo::EngineeringStressHelper::CalculateCoefficients2DPlaneStress(double rE,
                                                                                                     double rNu)
{
...
std::tuple<double, double, double> NuTo::EngineeringStressHelper::CalculateCoefficients3D(double rE, double rNu)
{
    ...
    return std::make_tuple(factor * (1.0 - rNu), // C11
                           factor * rNu, // C12
                           rE / (2. * (1.0 + rNu))); // C33
}
...
template <>
EngineeringStress<2> EngineeringStressHelper::GetStress<2>(const EngineeringStrain<2>& rElasticStrain, double rE,
