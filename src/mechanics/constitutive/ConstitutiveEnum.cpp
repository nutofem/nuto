...
const std::map<NuTo::Constitutive::eConstitutiveType, std::string> NuTo::Constitutive::GetConstitutiveTypeMap()
{
    const std::map<eConstitutiveType, std::string> map = {
            ...
            {eConstitutiveType::DAMAGE_VISCO_PLASTICITY_ENGINEERING_STRESS,
             "DAMAGE_VISCO_PLASTICITY_ENGINEERING_STRESS"},
            {eConstitutiveType::DAMAGE_VISCO_PLASTICITY_HARDENING_ENGINEERING_STRESS,
             "DAMAGE_VISCO_PLASTICITY_HARDENING_ENGINEERING_STRESS"},
            {eConstitutiveType::CREEP, "CREEP"},
            ...
            {eConstitutiveType::GRADIENT_DAMAGE_FATIGUE_ENGINEERING_STRESS,
             "GRADIENT_DAMAGE_FATIGUE_ENGINEERING_STRESS"},
            {eConstitutiveType::GRADIENT_DAMAGE_ENGINEERING_STRESS_FATIGUE,
             "GRADIENT_DAMAGE_ENGINEERING_STRESS_FATIGUE"},
            {eConstitutiveType::GRADIENT_DAMAGE_PLASTICITY_ENGINEERING_STRESS,
             "GRADIENT_DAMAGE_PLASTICITY_ENGINEERING_STRESS"},
            {eConstitutiveType::HEAT_CONDUCTION, "HEAT_CONDUCTION"},
            {eConstitutiveType::LATTICE_CONCRETE, "LATTICE_CONCRETE"},
            {eConstitutiveType::LINEAR_DIELECTRIC, "LINEAR_DIELECTRIC"},
            ...
            {eConstitutiveType::NONLOCAL_DAMAGE_PLASTICITY_ENGINEERING_STRESS,
             "NONLOCAL_DAMAGE_PLASTICITY_ENGINEERING_STRESS"},
            {eConstitutiveType::PHASE_FIELD, "PHASE_FIELD"},
            {eConstitutiveType::SHRINKAGE_CAPILLARY_STRAIN_BASED, "SHRINKAGE_CAPILLARY_STRAIN_BASED"},
            {eConstitutiveType::SHRINKAGE_CAPILLARY_STRESS_BASED, "SHRINKAGE_CAPILLARY_STRESS_BASED"},
            {eConstitutiveType::SHRINKAGE_SAW_STRESS_BASED, "SHRINKAGE_SAW_STRESS_BASED"},
            {eConstitutiveType::STRAIN_GRADIENT_DAMAGE_PLASTICITY_ENGINEERING_STRESS,
             "STRAIN_GRADIENT_DAMAGE_PLASTICITY_ENGINEERING_STRESS"},
...
NuTo::Constitutive::GetConstitutiveParameterMap()
{
    const std::map<eConstitutiveParameter, std::string> map = {
            ...
            {eConstitutiveParameter::DIELECTRIC_TENSOR, "DIELECTRIC_TENSOR"},
            ...
            {eConstitutiveParameter::GRADIENT_CORRECTION_ADSORPTION_DESORPTION,
             "GRADIENT_CORRECTION_ADSORPTION_DESORPTION"},
            {eConstitutiveParameter::GRADIENT_CORRECTION_DESORPTION_ADSORPTION,
            ...
            {eConstitutiveParameter::KELVIN_CHAIN_DAMPING, "KELVIN_CHAIN_DAMPING"},
            {eConstitutiveParameter::KELVIN_CHAIN_RETARDATIONTIME, "KELVIN_CHAIN_RETARDATIONTIME"},
            {eConstitutiveParameter::KELVIN_CHAIN_STIFFNESS, "KELVIN_CHAIN_STIFFNESS"},
...
{
    const std::map<eInput, std::string> lut = boost::assign::map_list_of(
            eInput::ENGINEERING_STRAIN, "ENGINEERING_STRAIN")(eInput::TEMPERATURE, "TEMPERATURE")(
            eInput::TEMPERATURE_GRADIENT, "TEMPERATURE_GRADIENT")(eInput::TEMPERATURE_CHANGE, "TEMPERATURE_CHANGE")(
            eInput::NONLOCAL_EQ_PLASTIC_STRAIN, "NONLOCAL_EQ_PLASTIC_STRAIN")(
            eInput::NONLOCAL_EQ_STRAIN, "NONLOCAL_EQ_STRAIN")(eInput::NONLOCAL_TOTAL_STRAIN_1D,
                                                              "NONLOCAL_TOTAL_STRAIN_1D")(eInput::ENGINEERING_STRESS_1D,
                                                                                          "ENGINEERING_STRESS_1D")(
            eInput::DEFORMATION_GRADIENT_REAL_1D, "DEFORMATION_GRADIENT_REAL_1D")(eInput::NONLOCAL_TOTAL_STRAIN_REAL_1D,
                                                                                  "NONLOCAL_TOTAL_STRAIN_REAL_1D")(
            eInput::NONLOCAL_TOTAL_STRAIN_VIRT_1D, "NONLOCAL_TOTAL_STRAIN_VIRT_1D")(
            eInput::RELATIVE_HUMIDITY, "RELATIVE_HUMIDITY")(eInput::RELATIVE_HUMIDITY_BOUNDARY,
                                                            "RELATIVE_HUMIDITY_BOUNDARY")(eInput::RELATIVE_HUMIDITY_DT1,
                                                                                          "RELATIVE_HUMIDITY_DT1")(
            eInput::RELATIVE_HUMIDITY_GRADIENT, "RELATIVE_HUMIDITY_GRADIENT")(eInput::WATER_VOLUME_FRACTION,
                                                                              "WATER_VOLUME_FRACTION")(
            eInput::WATER_VOLUME_FRACTION_DT1, "WATER_VOLUME_FRACTION_DT1")(eInput::WATER_VOLUME_FRACTION_GRADIENT,
...
{
    const std::map<eOutput, std::string> lut = boost::assign::map_list_of(
            eOutput::ENGINEERING_STRAIN, "ENGINEERING_STRAIN")(eOutput::D_ENGINEERING_STRAIN_D_RELATIVE_HUMIDITY,
            ...
            eOutput::ENGINEERING_STRAIN_VISUALIZE, "ENGINEERING_STRAIN_VISUALIZE")(eOutput::SHRINKAGE_STRAIN_VISUALIZE,
                                                                                   "SHRINKAGE_STRAIN_VISUALIZE")(
            eOutput::THERMAL_STRAIN, "THERMAL_STRAIN")(eOutput::ENGINEERING_PLASTIC_STRAIN_VISUALIZE,
                                                       "ENGINEERING_PLASTIC_STRAIN_VISUALIZE")(
            eOutput::ENGINEERING_VISCOPLASTIC_STRAIN_3D, "ENGINEERING_VISCOPLASTIC_STRAIN_3D")(
            eOutput::ENGINEERING_TOTAL_INELASTIC_STRAIN_3D,
            "ENGINEERING_TOTAL_INELASTIC_STRAIN_3D")(eOutput::ENGINEERING_STRESS, "ENGINEERING_STRESS")(
            eOutput::ENGINEERING_STRESS_VISUALIZE,
            "ENGINEERING_STRESS_VISUALIZE")(eOutput::ENGINEERING_STRESS_ELASTIC_1D, "ENGINEERING_STRESS_ELASTIC_1D")(
            eOutput::ENGINEERING_STRESS_ELASTIC_2D,
            "ENGINEERING_STRESS_ELASTIC_2D")(eOutput::ENGINEERING_STRESS_ELASTIC_3D, "ENGINEERING_STRESS_ELASTIC_3D")(
            ...
            eOutput::D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_1D,
            "D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_1D")(
            eOutput::D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_2D,
            "D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_2D")(
            eOutput::D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_3D,
            "D_ENGINEERING_STRESS_D_ENGINEERING_STRAIN_ELASTIC_3D")(
            eOutput::D_ENGINEERING_STRESS_D_NONLOCAL_EQ_PLASTIC_STRAIN_1D,
            "D_ENGINEERING_STRESS_D_NONLOCAL_EQ_PLASTIC_STRAIN_1D")(eOutput::D_ENGINEERING_STRESS_D_NONLOCAL_EQ_STRAIN,
                                                                    "D_ENGINEERING_STRESS_D_NONLOCAL_EQ_STRAIN")(
            eOutput::D_ENGINEERING_STRESS_D_NONLOCAL_TOTAL_STRAIN_1D,
            "D_ENGINEERING_STRESS_D_NONLOCAL_TOTAL_STRAIN_1D")(eOutput::D_ENGINEERING_STRESS_D_THERMAL_STRAIN,
            ...
            eOutput::D_STRAIN_D_TEMPERATURE, "D_STRAIN_D_TEMPERATURE")(eOutput::HEAT_FLUX, "HEAT_FLUX")(
            eOutput::HEAT_CHANGE, "HEAT_CHANGE")(eOutput::D_HEAT_FLUX_D_TEMPERATURE_GRADIENT,
                                                 "D_HEAT_FLUX_D_TEMPERATURE_GRADIENT")(
            eOutput::D_HEAT_D_TEMPERATURE, "D_HEAT_D_TEMPERATURE")(eOutput::DAMAGE, "DAMAGE")(
            eOutput::EXTRAPOLATION_ERROR, "EXTRAPOLATION_ERROR")(eOutput::UPDATE_STATIC_DATA, "UPDATE_STATIC_DATA")(
            eOutput::UPDATE_TMP_STATIC_DATA, "UPDATE_TMP_STATIC_DATA")(eOutput::LOCAL_EQ_PLASTIC_STRAIN,
                                                                       "LOCAL_EQ_PLASTIC_STRAIN")(
            eOutput::LOCAL_EQ_TOTAL_INELASTIC_STRAIN, "LOCAL_EQ_TOTAL_INELASTIC_STRAIN")(eOutput::LOCAL_EQ_STRAIN,
                                                                                         "LOCAL_EQ_STRAIN")(
            eOutput::D_LOCAL_EQ_PLASTIC_STRAIN_D_STRAIN_1D,
            "D_LOCAL_EQ_PLASTIC_STRAIN_D_STRAIN_1D")(eOutput::D_LOCAL_EQ_STRAIN_D_STRAIN, "D_LOCAL_EQ_STRAIN_D_STRAIN")(
            eOutput::ENGINEERING_STRESS_REAL_1D, "ENGINEERING_STRESS_REAL_1D")(eOutput::ENGINEERING_STRAIN_VIRT_1D,
                                                                               "ENGINEERING_STRAIN_VIRT_1D")(
            eOutput::D_ENGINEERING_STRESS_REAL_D_ENGINEERING_STRAIN_REAL_1D,
            "D_ENGINEERING_STRESS_REAL_D_ENGINEERING_STRAIN_REAL_1D")(
            eOutput::D_ENGINEERING_STRESS_REAL_D_NONLOCAL_TOTAL_STRAIN_REAL_1D,
            ...
            eOutput::D_ENGINEERING_STRAIN_VIRT_D_NONLOCAL_TOTAL_STRAIN_VIRT_1D,
            "D_ENGINEERING_STRAIN_VIRT_D_NONLOCAL_TOTAL_STRAIN_VIRT_1D")(eOutput::D_INTERNAL_GRADIENT_RH_D_RH_BB_H0,
