...
enum class eInput
{
    ...
    COORDINATES,
	// add axisymmetric input
	ENGINEERING_STRAIN_AxSy,
	ENGINEERING_STRAIN_AxSy_DT1
};
...
enum class eOutput
{
    ...
    NONLOCAL_RADIUS,
	// add axisymmetric output
    AXISYMMETRIC_STATE, //!< for telling the law method GetConstitutiveInputs, whether there is an axisymmetric state
	ENGINEERING_STRAIN_AxSy,
	D_LOCAL_EQ_STRAIN_D_STRAIN_AxSy,
	ENGINEERING_STRESS_AxSy,
	D_ENGINEERING_STRESS_AxSy_D_ENGINEERING_STRAIN_AxSy,
	D_ENGINEERING_STRESS_AxSy_D_ENGINEERING_STRAIN_AxSy_DT1,
	D_ENGINEERING_STRESS_AxSy_D_NONLOCAL_EQ_STRAIN,
    D_ENGINEERING_STRESS_AxSy_D_PHASE_FIELD,
    D_ELASTIC_ENERGY_DAMAGED_PART_D_ENGINEERING_STRAIN_AxSy
};
