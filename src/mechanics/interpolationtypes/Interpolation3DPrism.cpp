...
NuTo::Interpolation3DPrism::Interpolation3DPrism(NuTo::Node::eDof rDofType, NuTo::Interpolation::eTypeOrder rTypeOrder,
                                                 int rDimension)
...
Eigen::MatrixXd
NuTo::Interpolation3DPrism::CalculateDerivativeShapeFunctionsNatural(const Eigen::VectorXd& rCoordinates) const
{
    switch (mTypeOrder)
    {
    case NuTo::Interpolation::eTypeOrder::EQUIDISTANT1:
...
Eigen::VectorXd
NuTo::Interpolation3DPrism::CalculateNaturalSurfaceCoordinates(const Eigen::VectorXd& rNaturalSurfaceCoordinates,
                                                               int rSurface) const
{
    ...
    default:
        throw Exception(__PRETTY_FUNCTION__, "PRISM3D has exactly five surfaces, 0 to 4. You tried to access " +
                                                     std::to_string(rSurface) + ".");
    }
}

Eigen::MatrixXd NuTo::Interpolation3DPrism::CalculateDerivativeNaturalSurfaceCoordinates(
