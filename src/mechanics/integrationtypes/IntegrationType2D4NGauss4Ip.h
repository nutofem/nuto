...
class IntegrationType2D4NGauss4Ip : public IntegrationType2D
{
...
public:
    ...
    {
        return eIntegrationType::IntegrationType2D4NGauss4Ip;
    }
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::IntegrationType2D4NGauss4Ip)
#endif // ENABLE_SERIALIZATION
