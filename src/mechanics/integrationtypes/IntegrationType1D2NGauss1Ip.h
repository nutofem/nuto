...
//! @date November 2009
//! @brief ... integration types in 1D with two nodes Gauss integration and 1 integration point
class IntegrationType1D2NGauss1Ip : public IntegrationType1D
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    std::cout << "start serialize IntegrationType1D2NGauss1Ip" << std::endl;
#endif
        ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(IntegrationType1D);
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize IntegrationType1D2NGauss1Ip" << std::endl;
#endif
    }
#endif // ENABLE_SERIALIZATION
    ...
    {
        return eIntegrationType::IntegrationType1D2NGauss1Ip;
    }
