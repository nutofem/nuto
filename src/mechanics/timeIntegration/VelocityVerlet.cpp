...
void NuTo::VelocityVerlet::Solve(double rTimeDelta)
{
    ...
    {
        throw Exception(__PRETTY_FUNCTION__, "solution with constraints != 0 not yet implemented.");
    }
...
void NuTo::VelocityVerlet::Restore(const std::string& filename, std::string rType)
{
    try
    {
        ...
        if (rType == "BINARY")
        {
            ...
            if (tmpString != GetTypeId())
                throw Exception("[VelocityVerlet::Restore]Data type of object in file (" + tmpString +
    ...
    {
        throw Exception("[VelocityVerlet::Restore]Unhandled exception.");
    }
}
...
void NuTo::VelocityVerlet::Save(const std::string& filename, std::string rType) const
{
    try
    {
        ...
        {
            throw Exception("[VelocityVerlet::Save]File type not implemented.");
        }
    }
    ...
    {
        throw Exception("[VelocityVerlet::Save]Unhandled exception.");
    }
}
