...
namespace NuTo
{
class ConstraintLinearNodeElectricPotential : public ConstraintLinear, public ConstraintNode
{
public:
    ConstraintLinearNodeElectricPotential(const NodeBase* rNode, double rValue);
