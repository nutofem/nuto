...
//! @date October 2009
//! @brief ... class for all electric potential constraints applied to a group of nodes in 3D
class ConstraintLinearNodeGroupElectricPotential : public ConstraintNodeGroup, public ConstraintLinear
{
...
public:
    ...
    ConstraintLinearNodeGroupElectricPotential(const Group<NodeBase>* rGroup, double rValue);
...
protected:
    ...
    ConstraintLinearNodeGroupElectricPotential(){};

    double mRHS;
};
}//namespace NuTo
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::ConstraintLinearNodeGroupElectricPotential)
#endif // ENABLE_SERIALIZATION
