...
public:
    ...
    ConstraintLagrangeNodeGroupDisplacements1D(const Group<NodeBase>* rGroup, const Eigen::MatrixXd& rDirection, NuTo::Constraint::eEquationSign rEquationSign, double rValue);
