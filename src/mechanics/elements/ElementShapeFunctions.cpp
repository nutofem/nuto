...
Eigen::Matrix<double, 3, 1> ShapeFunctionsTrussOrder2(const Eigen::VectorXd& rCoordinates)
{
    ...
    shapeFunctions(0) = 0.5 * (1. - rCoordinates(0, 0)) - 0.5 * (1. - rCoordinates(0, 0) * rCoordinates(0, 0));
    shapeFunctions(1) = 1. - rCoordinates(0, 0) * rCoordinates(0, 0);
    shapeFunctions(2) = 0.5 * (1. + rCoordinates(0, 0)) - 0.5 * (1. - rCoordinates(0, 0) * rCoordinates(0, 0));
...
Eigen::Matrix<double, 3, 1> DerivativeShapeFunctionsTrussOrder2(const Eigen::VectorXd& rCoordinates)
{
    ...
    derivativeShapeFunctions(0) = -0.5 + rCoordinates(0, 0);
    derivativeShapeFunctions(1) = -2.0 * rCoordinates(0, 0);
    derivativeShapeFunctions(2) = 0.5 + rCoordinates(0, 0);
