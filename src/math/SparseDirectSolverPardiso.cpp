                                            ...
                                            Eigen::VectorXd& rSolution)
{
    ...
    if (error != 0)
    {
        throw NuTo::Exception(__PRETTY_FUNCTION__, "Numerical factorization phase: " + this->GetErrorString(error) + ".");
    }
    ...
    if (error != 0)
    {
        throw NuTo::Exception(__PRETTY_FUNCTION__, "Back substitution and iterative refinement phase: " + this->GetErrorString(error) + ".");
    }
