...
extern "C"
{
int dnaupd_(int* ido, char* bmat, int* n, char* which, int* nev,
            double* tol, double* resid, int* ncv, double* v, int* ldv,
            int* iparam, int* ipntr, double* workd, double* workl,
            int* lworkl, int* info);

int dneupd_(int* rvec, char* all, int* select, double* d_r, double* d_i, double* z,
            int* ldz, double* sigma_r, double* sigma_i, double* work_ev, char* bmat,
...
int dseupd_(int* rvec, char* all, int* select, double* d, double* z,
