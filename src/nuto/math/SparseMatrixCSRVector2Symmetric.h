...
template<class T>
void NuTo::SparseMatrixCSRVector2Symmetric<T>::Save ( const std::string &filename, std::string rType)const
{
	try
	 {
...
template<class T>
void NuTo::SparseMatrixCSRVector2Symmetric<T>::Restore ( const std::string &filename,  std::string rType)
{
	try
	{
		//transform to uppercase
