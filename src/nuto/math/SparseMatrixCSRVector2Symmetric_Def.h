...
#ifndef SPARSE_MATRIX_CSR_VECTOR2_SYMMETRIC_DEF_H
#define SPARSE_MATRIX_CSR_VECTOR2_SYMMETRIC_DEF_H
...
public:
    ...
    SparseMatrixCSRVector2Symmetric(FullMatrix<T>& rFullMatrix, double rAbsoluteTolerance = 0, double rRelativeTolerance = 1e-14);
    ...
    SparseMatrixCSRVector2Symmetric<T> operator* ( const T &rOther ) const;
