...
#ifndef RungeKutta3_H
#define RungeKutta3_H
...
class RungeKutta3 : public RungeKuttaBase
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    //! @brief constructor
    RungeKutta3(StructureBase* rStructure);
...
#ifdef ENABLE_SERIALIZATION
#ifndef SWIG
BOOST_CLASS_EXPORT_KEY(NuTo::RungeKutta3)
#endif // SWIG
#endif // ENABLE_SERIALIZATION
