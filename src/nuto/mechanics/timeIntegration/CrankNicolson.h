...
//! @date February 2012
//! @brief ... standard class for implicit timeintegration (static Newton Raphson or CrankNicolson for dynamics)
class CrankNicolson : public TimeIntegrationBase
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    //! @brief constructor
    CrankNicolson(StructureBase* rStructure);
...
#ifdef ENABLE_SERIALIZATION
#ifndef SWIG
BOOST_CLASS_EXPORT_KEY(NuTo::CrankNicolson)
#endif // SWIG
#endif // ENABLE_SERIALIZATION
