...
public:
    ...
    //!@brief sets the harmonic excitations in the format {DisplacementAmplitude,Frequency,NumberOfCycles} if displacement controlled or
    //!@brief in the format {LoadingAmplitude,Frequency,Number OfCycles} if load controlled
    //!@param sets the harmonic excitations in the format {DisplacementAmplitude,Frequency,NumberOfCycles} or {LoadingAmplitude,Frequency,Number OfCycles}
