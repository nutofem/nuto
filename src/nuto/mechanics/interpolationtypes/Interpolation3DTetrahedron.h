...
public:
    ...
    {
        throw("[NuTo::Interpolation3DTetrahedron::CalculateShapeFunctions] not implemented");
    }
    ...
    {
        throw("[NuTo::Interpolation3DTetrahedron::CalculateDerivativeShapeFunctionsNatural] not implemented");
    }
