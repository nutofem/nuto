...
public:
    ...
    {
        throw("[NuTo::Interpolation2DTriangle::CalculateShapeFunctions] not implemented");
    }
    ...
    {
        throw("[NuTo::Interpolation2DTriangle::CalculateDerivativeShapeFunctionsNatural] not implemented");
    }
