...
public:
    ...
    {
        throw("[NuTo::Interpolation3DBrick::CalculateShapeFunctions] not implemented");
    }
    ...
    {
        throw("[NuTo::Interpolation3DBrick::CalculateDerivativeShapeFunctionsNatural] not implemented");
    }
