...
NuTo::Interpolation2DTriangle::Interpolation2DTriangle(NuTo::Node::eAttributes rDofType, NuTo::Interpolation::eTypeOrder rTypeOrder) :
        Interpolation2D::Interpolation2D(rDofType, rTypeOrder)
{
    Initialize();
}
