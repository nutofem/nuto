...
public:
    ...
    {
        throw("[NuTo::Interpolation2DQuad::CalculateShapeFunctions] not implemented");
    }
    ...
    {
        throw("[NuTo::Interpolation2DQuad::CalculateDerivativeShapeFunctionsNatural] not implemented");
    }
