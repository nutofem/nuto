...
public:
    ...
    {
        throw("[NuTo::Interpolation1DTruss::CalculateShapeFunctions] not implemented");
    }
    ...
    {
        throw("[NuTo::Interpolation1DTruss::CalculateDerivativeShapeFunctionsNatural] not implemented");
    }
