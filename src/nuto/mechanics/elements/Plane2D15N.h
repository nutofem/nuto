...
//! @date December 2013
//! @brief 15 nodes triangular element

class Plane2D15N : public Plane2D
{
...
public:
    Plane2D15N(NuTo::StructureBase* rStructure, const std::vector<NuTo::NodeBase* >& rNodes,
    ...
    {
        assert(rLocalNodeNumber>=0 && rLocalNodeNumber<15);
    ...
    {
        return NuTo::Element::PLANE2D15N;
    }
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::Plane2D15N)
#endif // ENABLE_SERIALIZATION
