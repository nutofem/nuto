...
class Plane2D3N : public Plane2D
{
#ifdef ENABLE_SERIALIZATION
...
public:
    Plane2D3N(NuTo::StructureBase* rStructure, std::vector<NuTo::NodeBase* >& rNodes,
    ...
    {
        throw MechanicsException("[NuTo::Plane2D3N::CalculateGlobalDofs] to be implemented.");
    }
