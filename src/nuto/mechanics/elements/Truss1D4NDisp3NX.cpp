...
{
    ShapeFunctions1D::ShapeFunctions1D4N(rLocalCoordinates, rShapeFunctions);
}
...
{
    ShapeFunctions1D::DerivativeShapeFunctions1D4N(rLocalCoordinates, rDerivativeShapeFunctions);
}
