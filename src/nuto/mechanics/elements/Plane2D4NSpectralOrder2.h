...
#ifndef Plane2D4NSpectralOrder2_H
#define Plane2D4NSpectralOrder2_H
...
class Plane2D4NSpectralOrder2 : public Plane2D
{
...
public:
    Plane2D4NSpectralOrder2(NuTo::StructureBase* rStructure, std::vector<NuTo::NodeBase* >& rNodes,
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::Plane2D4NSpectralOrder2)
#endif // ENABLE_SERIALIZATION
