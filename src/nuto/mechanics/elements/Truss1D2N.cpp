...
NuTo::Truss1D2N::Truss1D2N(NuTo::StructureBase* rStructure, const std::vector<NuTo::NodeBase* >& rNodes,
...
//    temp = reinterpret_cast<std::uintptr_t&>(mNodes[1]);
//    ar & boost::serialization::make_nvp("mNode_1", temp);
