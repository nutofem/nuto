...
//! @date December 2013
//! @brief 10 nodes triangular element with the nodal positions in the natural coordinate system
//! defined by [0,0][1/sqrt(20),0][1-1/sqrt(20),0][1,0][0,1/sqrt(20)][1/3,1/3][1-1/sqrt(20),1/sqrt(20)]...

class Plane2D10N : public Plane2D
{
...
public:
    Plane2D10N(NuTo::StructureBase* rStructure, const std::vector<NuTo::NodeBase* >& rNodes,
    ...
    {
        return NuTo::Element::PLANE2D10N;
    }
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::Plane2D10N)
#endif // ENABLE_SERIALIZATION
