...
NuTo::BoundaryType::eType NuTo::BoundaryElement2D::GetBoundaryConditionType() const
{
    return mBoundaryConditionType;
}

void NuTo::BoundaryElement2D::SetBoundaryConditionType(BoundaryType::eType rBoundaryConditionType)
{
