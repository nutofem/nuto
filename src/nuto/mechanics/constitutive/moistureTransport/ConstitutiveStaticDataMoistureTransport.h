#ifndef CONSTITUTIVESTATICDATAMOISTURETRANSPORT_H
#define CONSTITUTIVESTATICDATAMOISTURETRANSPORT_H
...
public:
    ...
    FullVector<double,Eigen::Dynamic>                       GetActualSorptionCoeff                  () const;
    ...
    void                                                    SetActualSorptionCoeff                  (FullVector<double,Eigen::Dynamic> rActualSorptionCoeff);
...
protected:
    ...
    double  mActualJunctionPoint            = 0.0;
...
#endif // CONSTITUTIVESTATICDATAMOISTURETRANSPORT_H
