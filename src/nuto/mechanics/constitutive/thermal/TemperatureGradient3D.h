...
#ifndef TemperatureGradient3D_H
#define TemperatureGradient3D_H
...
//! @date June 2012
class TemperatureGradient3D : public ConstitutiveInputBase
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    TemperatureGradient3D();


    const TemperatureGradient3D& GetTemperatureGradient3D()const
    {
    	return *this;
    }
...
private:
    //! @brief ... temperature gradient
    double mTemperatureGradient[3];
};

}

#endif // TemperatureGradient3D_H
