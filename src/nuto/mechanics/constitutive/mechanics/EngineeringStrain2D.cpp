...
NuTo::EngineeringStrain2D::EngineeringStrain2D() : ConstitutiveOutputBase::ConstitutiveOutputBase(),ConstitutiveInputBase::ConstitutiveInputBase(), FullVector<double,3>()
{
	(*this)[0] = 0.0;
	(*this)[1] = 0.0;
	(*this)[2] = 0.0;
