...
NuTo::FullVector<double,Eigen::Dynamic> NuTo::ConstitutiveStaticDataMoistureTransport::GetCurrentSorptionCoeff () const
{
...
void NuTo::ConstitutiveStaticDataMoistureTransport::SetCurrentSorptionCoeff(FullVector<double,Eigen::Dynamic> rCurrentSorptionCoeff)
{
    ...
    default:
    {
        throw NuTo::MechanicsException("[NuTo::ConstitutiveStaticDataMoistureTransport::SetCurrentSorptionCoeff] The vector for the sorption coefficients must have 3 or 4 rows. --- Polynom of 3th degree --- in case of 4 coefficients the constant term will be deleted");
        break;
    }
    }
}
