...
enum eInput
{
    ...
    WATER_PHASE_FRACTION_BOUNDARY,      //!<
    WATER_PHASE_FRACTION_D1             //!< first time derivative
};
}
...
enum eOutput
{
    ...
    VAPOR_PHASE_DIFFUSION_COEFFICIENT_GRADIENT,
    VAPOR_PHASE_SATURATION_DENSITY_TIMES_VAPOR_PHASE_VOLUME_FRACTION,
    VAPOR_PHASE_SATURATION_DENSITY_TIMES_RELATIVE_HUMIDITY,
    VAPOR_PHASE_SATURATION_DENSITY_TIMES_RELATIVE_HUMIDITY_D1,
    VAPOR_PHASE_SATURATION_DENSITY_TIMES_WATER_VOLUME_FRACTION_D1,
    WATER_PHASE_DIFFUSION_COEFFICIENT,
    WATER_PHASE_DIFFUSION_COEFFICIENT_GRADIENT,
    WATER_PHASE_DENSITY,
