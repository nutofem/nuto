...
{
	throw MechanicsException("[NuTo::ConstitutiveTangentLocal<1,1>::AsConstitutiveTangentLocal_1x1] wrong return type.");
}
...
{
	throw MechanicsException("[NuTo::ConstitutiveTangentLocal<6,6>::AsConstitutiveTangentLocal_6x6] wrong return type.");
}
