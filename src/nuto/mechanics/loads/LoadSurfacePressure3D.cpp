...
//! @brief constructor
NuTo::LoadSurfacePressure3D::LoadSurfacePressure3D(int rLoadCase, StructureBase* rStructure, int rElementGroupId,
                                                   int rNodeGroupId, double rPressure)
...
void NuTo::LoadSurfacePressure3D::CalculateSurfaceLoad(NuTo::FullVector<double, 3>& rCoordinates,
                                                       NuTo::FullVector<double, 3>& rNormal,
