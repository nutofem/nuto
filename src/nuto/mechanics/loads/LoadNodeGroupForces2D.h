// $Id$
#ifndef LOADNODEGROUPFORCES2D_H
#define LOADNODEGROUPFORCES2D_H
...
public:
    ...
    LoadNodeGroupForces2D(const Group<NodeBase>* rGroup, const NuTo::FullMatrix<double,Eigen::Dynamic,Eigen::Dynamic>& rDirection, double rValue);
