...
//		return mMGYoungsModulus[rElementNumber];
    ...
    Error::eError BuildGlobalGradientInternalPotentialSubVectors(NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofGradientVector, NuTo::FullVector<double,Eigen::Dynamic>& rDependentDofGradientVector)
    {
...
//*************************************************
    ...
    void NodeExtractDofValues(NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofValues, NuTo::FullVector<double,Eigen::Dynamic>& rDependentDofValues) const
    {
        throw MechanicsException ( "[NuTo::StructureGrid::NodeExtractDofValues] Routine is not implemented." );
    }

    //! @brief merge dof values
    void NodeMergeActiveDofValues(const NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofValues)
    {
        throw MechanicsException ( "[NuTo::StructureGrid::NodeMergeActiveDofValues] Routine is not implemented." );
    }
    //! @brief get internal forces
    void NodeGetInternalForce(const NodeBase* rNode, NuTo::FullVector<double,Eigen::Dynamic>& rNodeForce)const
    {
    ...
    void NodeGetInternalForce(int rNodeId, NuTo::FullVector<double,Eigen::Dynamic>& rNodeForce)const
    {
        throw MechanicsException ( "[NuTo::StructureGrid::NodeGetInternalForce] Routine is not implemented." );
    }
    ...
    //! @param rActiveDofValues ... vector of global active dof values (ordering according to global dofs, size is number of active dofs)
    //! @param rDependentDofValues ... vector of global dependent dof values (ordering according to (global dofs) - (number of active dofs), size is (total number of dofs) - (number of active dofs))
    void NodeExtractDofValues(int rTimeDerivative, NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofValues, NuTo::FullVector<double,Eigen::Dynamic>& rDependentDofValues) const
    {
        throw MechanicsException ( "[NuTo::StructureGrid::NodeExtractDofValues] Routine is not implemented." );
    }
    ...
    //! @brief write dof values (e.g. displacements, temperatures to the nodes)
     ...
     void NodeMergeDofValues(int rTimeDerivative, const NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofValues, const NuTo::FullVector<double,Eigen::Dynamic>& rDependentDofValues)
     {
     ...
     void NodeMergeActiveDofValues(int rTimeDerivative, const NuTo::FullVector<double,Eigen::Dynamic>& rActiveDofValues)
     {
         throw MechanicsException ( "[NuTo::StructureGrid::NodeMergeActiveDofValues] Routine is not implemented." );
     }
