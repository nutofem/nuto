...
//! @param ... rMin ... minimum radius
//! @param ... rMax ... maximum radius
void NuTo::StructureBase::GroupAddNodeCylinderRadiusRange(int rIdentGroup, NuTo::FullVector<double, Eigen::Dynamic> rCenter, NuTo::FullVector<double, Eigen::Dynamic> rDirection, double rMin,
    double rMax)
{
#ifdef SHOW_TIME
std::clock_t start, end;
