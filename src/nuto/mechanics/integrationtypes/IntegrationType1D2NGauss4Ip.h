// $Id$
#ifndef IntegrationType1D2NGauss4Ip_H
#define IntegrationType1D2NGauss4Ip_H
...
//! @date Jan 2015
//! @brief ... integration types in 1D with Gauss integration and 4 integration points
class IntegrationType1D2NGauss4Ip : public IntegrationType1D
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    std::cout << "start serialize IntegrationType1D2NGauss4Ip" << std::endl;
#endif
        ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(IntegrationType1D);
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize IntegrationType1D2NGauss4Ip" << std::endl;
#endif
    }
#endif // ENABLE_SERIALIZATION
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::IntegrationType1D2NGauss4Ip)
#endif

#endif //IntegrationType1D2NGauss4Ip_H
