// $Id$
#ifndef IntegrationType2D3NGauss4Ip_H
#define IntegrationType2D3NGauss4Ip_H
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::IntegrationType2D3NGauss4Ip)
#endif // ENABLE_SERIALIZATION

#endif //IntegrationType2D3NGauss4Ip_H
