// $Id$
#ifndef IntegrationType1D2NGauss3Ip_H
#define IntegrationType1D2NGauss3Ip_H
...
class IntegrationType1D2NGauss3Ip : public IntegrationType1D
{
#ifdef ENABLE_SERIALIZATION
...
public:
    ...
    std::cout << "start serialize IntegrationType1D2NGauss3Ip" << std::endl;
#endif
        ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(IntegrationType1D);
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize IntegrationType1D2NGauss3Ip" << std::endl;
#endif
    }
#endif // ENABLE_SERIALIZATION
...
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::IntegrationType1D2NGauss3Ip)
#endif
#endif //IntegrationType1D2NGauss3Ip_H
