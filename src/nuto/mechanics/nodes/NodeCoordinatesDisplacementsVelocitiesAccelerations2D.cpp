...
//! @return enum
NuTo::Node::eNodeType NuTo::NodeCoordinatesDisplacementsVelocitiesAccelerations2D::GetNodeType()const
{
    return Node::NodeCoordinatesDisplacementsVelocitiesAccelerations2D;
}
