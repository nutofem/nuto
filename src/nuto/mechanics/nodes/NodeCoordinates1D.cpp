...
template void NuTo::NodeCoordinates1D::serialize(boost::archive::binary_oarchive & ar, const unsigned int version);
template void NuTo::NodeCoordinates1D::serialize(boost::archive::xml_oarchive & ar, const unsigned int version);
template void NuTo::NodeCoordinates1D::serialize(boost::archive::text_oarchive & ar, const unsigned int version);
template void NuTo::NodeCoordinates1D::serialize(boost::archive::binary_iarchive & ar, const unsigned int version);
template void NuTo::NodeCoordinates1D::serialize(boost::archive::xml_iarchive & ar, const unsigned int version);
template void NuTo::NodeCoordinates1D::serialize(boost::archive::text_iarchive & ar, const unsigned int version);
template<class Archive>
void NuTo::NodeCoordinates1D::serialize(Archive & ar, const unsigned int version)
{
#ifdef DEBUG_SERIALIZATION
    std::cout << "start serialize NodeCoordinates1D" << std::endl;
#endif
    ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(NodeBase)
       & BOOST_SERIALIZATION_NVP(mCoordinates);
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize NodeCoordinates1D" << std::endl;
#endif
}
BOOST_CLASS_EXPORT_IMPLEMENT(NuTo::NodeCoordinates1D)
BOOST_CLASS_TRACKING(NuTo::NodeCoordinates1D, track_always)
#endif // ENABLE_SERIALIZATION
...
//! @return enum
NuTo::Node::eNodeType NuTo::NodeCoordinates1D::GetNodeType()const
{
    return NuTo::Node::NodeCoordinates1D;
}
