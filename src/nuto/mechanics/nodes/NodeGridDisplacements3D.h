...
class NodeGridDisplacements3D : public NodeGrid3D, public NodeDof<0,3,0,0>
{
...
public:
    ...
    //! @brief constructor
    NodeGridDisplacements3D() : NodeGrid3D (), NodeDof<0,3,0,0>()
    {}
    ...
    void serialize(Archive & ar, const unsigned int version)
    {
        ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(NodeGrid3D)
           & BOOST_SERIALIZATION_BASE_OBJECT_NVP(BOOST_IDENTITY_TYPE((NodeDof<0,3,0,0>)));
    }
#endif  // ENABLE_SERIALIZATION
    ...
    {
        NodeDof<0,3,0,0>::SetGlobalDofs(rDOF);
    }
    ...
    {
    	NodeDof<0,3,0,0>::SetGlobalDofValues(rTimeDerivative, rActiveDofValues, rDependentDofValues);
    }
    ...
    {
        NodeDof<0,3,0,0>::GetGlobalDofValues(rTimeDerivative, rActiveDofValues, rDependentDofValues);
    }
    ...
    {
    	NodeDof<0,3,0,0>::RenumberGlobalDofs(rMappingInitialToNewOrdering);
    }
