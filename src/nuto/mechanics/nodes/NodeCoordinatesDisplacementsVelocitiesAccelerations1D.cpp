...
//! @return enum
NuTo::Node::eNodeType NuTo::NodeCoordinatesDisplacementsVelocitiesAccelerations1D::GetNodeType()const
{
    return Node::NodeCoordinatesDisplacementsVelocitiesAccelerations1D;
}
