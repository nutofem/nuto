...
public:
    ...
    void operator=(NodeDisplacements3D const& rOther)
    {
    	mDisplacements[0] = rOther.mDisplacements[0];
    	mDisplacements[1] = rOther.mDisplacements[1];
    	mDisplacements[2] = rOther.mDisplacements[2];
    	mDOF[0] = -1;
    	mDOF[1] = -1;
    	mDOF[2] = -1;
    }
