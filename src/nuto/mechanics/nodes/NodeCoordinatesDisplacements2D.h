// $Id$
#ifndef NodeCoordinatesDisplacements_2d_H
#define NodeCoordinatesDisplacements_2d_H
...
class NodeCoordinatesDisplacements2D : public NodeCoordinates2D, public NodeDisplacements2D
{
...
public:
    ...
    NodeCoordinatesDisplacements2D(NodeCoordinatesDisplacements2D const& rOther)
    {
        (*this) = rOther;
    }

    //! @brief clones (copies) the node with all its data, it's supposed to be a new node, so be careful with ptr
    NodeCoordinatesDisplacements2D* Clone()const
    {
    	return new NodeCoordinatesDisplacements2D(*this);
    }

    //! @brief assignment operator
    NodeCoordinatesDisplacements2D& operator= (NodeCoordinatesDisplacements2D const& rOther);
    ...
    {
    	return std::string("NodeCoordinatesDisplacements2D");
    }
    ...
    {
        return Node::NodeCoordinatesDisplacements2D;
    }
};
}
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::NodeCoordinatesDisplacements2D)
namespace boost{
template<>
struct is_virtual_base_of<NuTo::NodeCoordinates2D, NuTo::NodeCoordinatesDisplacements2D>: public mpl::true_ {};
template<>
struct is_virtual_base_of<NuTo::NodeDisplacements2D, NuTo::NodeCoordinatesDisplacements2D>: public mpl::true_ {};
}
#endif // ENABLE_SERIALIZATION

#endif //NodeCoordinatesDisplacements_2d_H
