...
//! @return enum
NuTo::Node::eNodeType NuTo::NodeCoordinatesDisplacementsVelocitiesAccelerations3D::GetNodeType()const
{
    return Node::NodeCoordinatesDisplacementsVelocitiesAccelerations3D;
}
