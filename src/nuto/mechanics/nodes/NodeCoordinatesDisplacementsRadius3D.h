// $Id:$
#ifndef NodeCoordinatesDisplacementsRadius_3d_H
#define NodeCoordinatesDisplacementsRadius_3d_H
...
class NodeCoordinatesDisplacementsRadius3D : public  NodeCoordinates3D, public NodeDisplacements3D, public NodeRadius
{
...
public:
    ...
    NodeCoordinatesDisplacementsRadius3D(NodeCoordinatesDisplacementsRadius3D const& rOther)
    {
        (*this) = rOther;
    }

    //! @brief clones (copies) the node with all its data, it's supposed to be a new node, so be careful with ptr
    NodeCoordinatesDisplacementsRadius3D* Clone()const
    {
    	return new NodeCoordinatesDisplacementsRadius3D(*this);
    }

    //! @brief assignment operator
    NodeCoordinatesDisplacementsRadius3D& operator= (NodeCoordinatesDisplacementsRadius3D const& rOther);
    ...
    {
    	return std::string("NodeCoordinatesDisplacementsRadius3D");
    }
    ...
    {
        return Node::NodeCoordinatesDisplacementsRadius3D;
    }
};
}
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::NodeCoordinatesDisplacementsRadius3D)
namespace boost{
template<>
struct is_virtual_base_of<NuTo::NodeCoordinates3D, NuTo::NodeCoordinatesDisplacementsRadius3D>: public mpl::true_ {};
template<>
struct is_virtual_base_of<NuTo::NodeDisplacements3D, NuTo::NodeCoordinatesDisplacementsRadius3D>: public mpl::true_ {};
template<>
struct is_virtual_base_of<NuTo::NodeRadius, NuTo::NodeCoordinatesDisplacementsRadius3D>: public mpl::true_ {};
}
#endif// ENABLE_SERIALIZATION

#endif //NodeCoordinatesDisplacementsRadius_3d_H
