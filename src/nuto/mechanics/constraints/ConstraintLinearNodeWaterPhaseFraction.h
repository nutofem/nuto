...
class ConstraintLinearNodeWaterPhaseFraction : public ConstraintNode, public ConstraintLinear
{
public:
                                ConstraintLinearNodeWaterPhaseFraction          (const NodeBase* rNode, double rValue);
