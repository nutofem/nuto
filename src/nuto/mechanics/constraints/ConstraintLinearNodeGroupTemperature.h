...
#ifndef CONSTRAINTNODEGROUPTEMPERATURE_H
#define CONSTRAINTNODEGROUPTEMPERATURE_H
...
class ConstraintLinearNodeGroupTemperature : public ConstraintNodeGroup, public ConstraintLinear
{
...
public:
    ...
    ConstraintLinearNodeGroupTemperature(const Group<NodeBase>* rGroup, double rValue);
    ...
    {
        throw MechanicsException("[NuTo::ConstraintLinearNodeGroupTemperature::Info] to be implemented.");
    }
...
protected:
    ...
    ConstraintLinearNodeGroupTemperature(){};

    double mRHS;
};
}//namespace NuTo
#ifdef ENABLE_SERIALIZATION
BOOST_CLASS_EXPORT_KEY(NuTo::ConstraintLinearNodeGroupTemperature)
#endif // ENABLE_SERIALIZATION
#endif //CONSTRAINTNODEGROUPTEMPERATURE_H
