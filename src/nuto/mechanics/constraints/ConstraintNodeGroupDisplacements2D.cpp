...
void NuTo::ConstraintNodeGroupDisplacements2D::serialize(Archive & ar, const unsigned int version)
{
    ...
    std::cout << "start serialize ConstraintNodeGroupDisplacements2D" << std::endl;
#endif
...
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize ConstraintNodeGroupDisplacements2D" << std::endl;
#endif
}
BOOST_CLASS_EXPORT_IMPLEMENT(NuTo::ConstraintNodeGroupDisplacements2D)
#endif // ENABLE_SERIALIZATION
