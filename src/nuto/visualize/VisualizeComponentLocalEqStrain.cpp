...
NuTo::VisualizeComponentLocalEqStrain::VisualizeComponentLocalEqStrain() : VisualizeComponentBase::VisualizeComponentBase()
{}
...
void NuTo::VisualizeComponentNonlocalEqStrain::serialize(Archive & ar, const unsigned int version)
{
    ...
    std::cout << "start serialize VisualizeComponentLocalEqStrain" << std::endl;
#endif
    ar & BOOST_SERIALIZATION_BASE_OBJECT_NVP(VisualizeComponentBase);
#ifdef DEBUG_SERIALIZATION
    std::cout << "finish serialize VisualizeComponentLocalEqStrain" << std::endl;
#endif
}
BOOST_CLASS_EXPORT_IMPLEMENT(NuTo::VisualizeComponentLocalEqStrain)
#endif // ENABLE_SERIALIZATION
