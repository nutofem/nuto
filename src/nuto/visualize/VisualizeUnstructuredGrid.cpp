...
void NuTo::VisualizeUnstructuredGrid::ExportVtkDataFile(const std::string& rFilename) const
{
    ...
    file << "Data file was generated by NuTo\n";
    file << "ASCII\n";
    file << "DATASET UNSTRUCTURED_GRID\n";
    ///////////////////////////////////////////////////////////////////////////

    // Points /////////////////////////////////////////////////////////////////
    file << "POINTS " << this->mPoints.size() << " double\n";
    ...
    file << "CELLS " << this->mCells.size() << " " << TotalCellSize << '\n';
    ...
    file << "CELL_TYPES " << this->mCells.size() << '\n';
    CellIter = this->mCells.begin();
    while (CellIter != this->mCells.end())
    {
    ...
    // Point data /////////////////////////////////////////////////////////////
    file << '\n';
    file << "POINT_DATA " << this->mPoints.size() << '\n';
    for (unsigned int PointDataCount = 0; PointDataCount < this->mPointData.size(); PointDataCount++)
    {
        switch (this->mPointData[PointDataCount].GetDataType())
        {
        case NuTo::eVisualizeDataType::SCALAR:
            file << "SCALARS " << this->mPointData[PointDataCount].GetIdent() << " double 1\n";
            file << "LOOKUP_TABLE default\n";
            break;
        case NuTo::eVisualizeDataType::VECTOR:
            file << "VECTORS " << this->mPointData[PointDataCount].GetIdent() << " double\n";
            break;
        case NuTo::eVisualizeDataType::TENSOR:
            file << "TENSORS " << this->mPointData[PointDataCount].GetIdent() << " double\n";
            break;
        case NuTo::eVisualizeDataType::FIELD:
            file << "FIELD " << this->mPointData[PointDataCount].GetIdent() << " 1\n";
            file << this->mPointData[PointDataCount].GetIdent() << " " << this->mPointData[PointDataCount].GetNumData() << " " << this->mPoints.size() << " double\n";
            break;
        default:
            continue;
        }
    ...
    // Cell data //////////////////////////////////////////////////////////////
    file << '\n';
    file << "CELL_DATA " << this->mCells.size() << '\n';
    for (unsigned int CellDataCount = 0; CellDataCount < this->mCellData.size(); CellDataCount++)
    {
        ...
        {
        case NuTo::eVisualizeDataType::SCALAR:
            file << "SCALARS " << this->mCellData[CellDataCount].GetIdent() << " double 1\n";
            file << "LOOKUP_TABLE default\n";
            break;
        case NuTo::eVisualizeDataType::VECTOR:
            file << "VECTORS " << this->mCellData[CellDataCount].GetIdent() << " double\n";
            break;
        case NuTo::eVisualizeDataType::TENSOR:
            file << "TENSORS " << this->mCellData[CellDataCount].GetIdent() << " double\n";
            break;
        case NuTo::eVisualizeDataType::FIELD:
            file << "FIELD " << this->mCellData[CellDataCount].GetIdent() << " 1\n";
            file << this->mCellData[CellDataCount].GetIdent() << " " << this->mCellData[CellDataCount].GetNumData() << " " << this->mCells.size() << " double\n";
            break;
        default:
            continue;
        }
