...
void NuTo::PolynomialLeastSquaresFitting::AddBoundaryCondition(std::pair<double, double> rBoundaryCondition)
{
    ...
    {
        throw Exception("[NuTo::PolynomialLeastSquaresFitting::AddBoundaryCondition] The number of boundary conditions can't be higher than the degree of the polynom.");
    }
}
