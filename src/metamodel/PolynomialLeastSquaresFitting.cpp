...
void NuTo::PolynomialLeastSquaresFitting::AddBoundaryCondition(std::pair<double, double> rBoundaryCondition)
{
    ...
    {
        throw MetamodelException("[NuTo::PolynomialLeastSquaresFitting::AddBoundaryCondition] The number of boundary "
...
void NuTo::PolynomialLeastSquaresFitting::BuildDerived()
{
    ...
    catch (NuTo::Exception& e)
    {
        ...
        myException.AddMessage(
                "[NuTo::PolynomialLeastSquaresFitting::BuildDerived] error calculating the polynomial coefficients.");
        throw myException;
    }
}
                                                           ...
                                                           Eigen::MatrixXd& rOutputCoordinates) const
{
    ...
    {
        throw MetamodelException("[NuTo::PolynomialLeastSquaresFitting::SolveTransformed] Dimension of input (number "
                                 "of rows) has to be 1.");
    }
    int numCoefficients = this->mPolynomialCoeffs.rows();
    if (numCoefficients != mDegree + 1)
    {
        throw MetamodelException("[NuTo::PolynomialLeastSquaresFitting::SolveTransformed] invalid number of polynomial "
