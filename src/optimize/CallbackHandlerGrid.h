...
public:
    ...
    virtual const boost::dynamic_bitset<> GetDisplacementConstaints()
    {
        throw OptimizeException("[CallbackHandlerGrid::GetDisplacementConstaints] GetDisplacementConstaints function "
    ...
    virtual void HangingNodesCorrection(std::vector<double>& u)
    {
        throw OptimizeException("[CallbackHandlerGrid::HangingNodesCorrection] HangingNodesCorrection function not "
    ...
    virtual void SetMisesWielandt(bool rMisesWielandt)
    {
        throw OptimizeException("[CallbackHandlerGrid::SetMisesWielandt] SetMisesWielandt function not implemented in "
                                "CallbackHandlerGrid object.");
    }
    virtual double GetWeightingFactor()
    {
        throw OptimizeException("[CallbackHandlerGrid::GetWeightingFactor] GetWeightingFactor function not implemented "
