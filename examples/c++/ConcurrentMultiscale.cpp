...
try
{
    ...
    myStructure.ImportFromGmsh("ConcurrentMultiscale.msh","displacements", "ConstitutiveLawIpNonlocal", "StaticDataNonlocal",createdGroupIds);
...
//    maxStrain(2,0) = -100*fct/YoungsModulusDamage;
    ...
    myStructure.ExportVtkDataFile("ConcurrentMultiscale.vtk");
#endif
