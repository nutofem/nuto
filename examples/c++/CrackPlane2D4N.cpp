...
DBG_PRINT_VAL(crack5)
        ...
        myStructure.AddVisualizationComponent(visualizationGroup, NuTo::VisualizeBase::ELEMENT);
        myStructure.AddVisualizationComponent(visualizationGroup, NuTo::VisualizeBase::SECTION);
        myStructure.AddVisualizationComponent(visualizationGroup, NuTo::VisualizeBase::CRACK);
