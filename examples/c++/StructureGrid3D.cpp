 ...
 */
       ...
       NuTo::CallbackHandlerGrid myCallback;
        ...
        NuTo::FullMatrix<double> returnVector(myGrid.GetNumDofs(),1);
        std::cout<<__FILE__<<" "<<__LINE__<<" startVector filled, last value"<<startVector(myGrid.GetNumDofs()-1,0)<<std::endl;
